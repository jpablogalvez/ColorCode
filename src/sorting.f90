...
!======================================================================!
!
! SINSORT - Single precision INsertion SORT
!
! Seen on: https://rosettacode.org/wiki/Sorting_algorithms/Insertion_sort
!
       subroutine sinsort(n,a,b)
!
       implicit none
!
       integer :: n, i, j
       real(kind=4) :: a(n),b(n),xa,xb
!
       do i = 2, n
!
         xa = a(i)
...
!======================================================================!
!
! SVQSORT - Single precision Vector Quicksort
!
! Seen on: https://cs.stackexchange.com/questions/104816/implementation-of-quicksort-to-handle-duplicates
!
       recursive subroutine svqsort(n,ref,targ,low,high)
!
! Input/output variables
!
       real(kind=4),dimension(n),intent(inout)  ::  ref
       real(kind=4),dimension(n),intent(inout)  ::  targ
       integer,intent(in)                       ::  n
       integer,intent(in)                       ::  low
       integer,intent(in)                       ::  high
!
...
! Sorting the partitions not containing duplicates
!
         call svqsort(n,ref,targ,low,left-1)
         call svqsort(n,ref,targ,right,high)

       end if
!
       end subroutine svqsort
!
!======================================================================!
!
